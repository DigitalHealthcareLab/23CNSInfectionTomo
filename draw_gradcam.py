...
class GradCAM3D:
    def __init__(self, model, target_layer):
        ...
        #self.sub_model = nn.Sequential(*list(model.features.children())[:-2])
...
def main(task_name:str, input_file:Path):
    ...
    device = get_device()
    # Load the models
    model_path = '/home/bkchoi/tomocube_preprocess_yang/bkchoi/model/gene_NKTR_model.pt'
    #model_path = f'/home/bkchoi/tomocube_preprocess_yang/bkchoi/model/20fold/best/{task_name}_0.pt'
...
if __name__ == '__main__':
    ...
    input_file = Path('/home/bkchoi/tomocube_preprocess_yang/data/processed/input/hsv/20220224.134827.880.Default-002_RI Tomogram.npy')
    main(task_name, input_file)
    

# RPL19
'data/processed_tomocube/20220613/20220613.133649.307.CD8-074_RI Tomogram.npy'
'data/processed_tomocube/20220607_3/20220607.175819.116.CD8_3-076_RI Tomogram.npy'
'data/processed_tomocube/20220607_3/20220607.180313.240.CD8_3-085_RI Tomogram.npy'
'data/processed_tomocube/20220607_3/20220607.180415.396.CD8_3-088_RI Tomogram.npy'
