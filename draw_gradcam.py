...
if __name__ == '__main__':
    input_file = Path('/home/data/cns_tomocube/processed/input/20220609_csf/20220609.130047.676.CSF-001_RI.npy') # SAMPLE
    model_path = Path('model/prognosis/10fold/best/csf_good_poor_0.pt')
    main(task_name, input_file, model_path)